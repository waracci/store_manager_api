...
class Product():
    """This class defines the Product model and the various methods of manipulating the product data"""

    product_id = 1
    product_quantity_store = 0
    productList = []

    def __init__(self, product_name, product_description, product_quantity, product_category, product_moq):
        ...
        self.product_quantity_store = Product.product_quantity_store + product_quantity 
